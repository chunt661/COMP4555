Shader "Hidden/.poiyomi/★ Poiyomi Pro ★/ScifiBattleshipExcaliburBlue-ScifiBattleshipExcaliburBlue"
{
    Properties
    {
        [HideInInspector] shader_is_using_thry_editor ("", Float) = 0
        [HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi Pro V7.3.025</color>", Float) = 0
...
#define PROP_SHADOWSTRENGTH 0.047
...
#define PROP_EMISSIONSTRENGTH 6.75
...
#define PROP_STENCILCOMPAREFUNCTION 0
